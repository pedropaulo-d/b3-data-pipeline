...
**Status atual:** Etapa 0 — Preparação ✅. Próxima: Ingestão manual com Python puro.
...
| 1     | Ingestão manual com Python puro     | 🔜 Próxima     |
| 2     | Object storage com MinIO            | ⏳ Pendente    |
...
As decisões de arquitetura e seus trade-offs estão documentadas em [`docs/decisoes.md`](docs/decisoes.md). Resumo das três decisões já tomadas:
